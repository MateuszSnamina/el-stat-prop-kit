...
namespace el_stat_prop {
    ...
    public:
        ...
        virtual double value_electron(arma::mat density_matrix_alpha, arma::mat density_matrix_beta) const;
        virtual double value_electron() const; //density matrices taken from m_system    
    ...
    public:
        ...
        arma::vec nuclei_contraction_coeffs() const override;
    public:
        using ReferencePointBitsList = PossibleBitsList<
